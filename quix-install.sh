...
CONFIG_FILE='quix.conf'
CONFIGFOLDER='/root/.quixcore'
COIN_DAEMON='/root/quix/QUIX_LINUX/quixd'
COIN_CLI='/root/quix/QUIX_LINUX/quix-cli'
COIN_DAEMON2='quixd'
COIN_CLI2='quix-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/quixcoin/quix/releases/download/0.12.1.1/QUIX_LINUX.tar.gz'
COIN_ZIP='/root/quix/QUIX_LINUX.tar.gz'
COIN_NAME='QUIX'
COIN_PORT=6333
